...
문서 경로: `.agent/ai-context/collaboration-ops-plan.md`
...
### 실행 기록 작성 위치
1. 오늘 작업 계획: `.agent/ai-context/01-today-plan.md`
2. 완료 반영: `.agent/ai-context/02-progress.md`
3. 미해결 이슈/리스크: `.agent/ai-context/03-open-issues.md`
4. 다음 세션 인수인계: `.agent/ai-context/05-handoff.md`
5. 상세 타임라인 로그: `.agent/ai-context/logs/YYYY-MM-DD-session-log.md`
...
`이 문서를 기준으로 .agent/ai-context를 자동 정리해줘. Active Docs만 최신 상태로 유지하고, 오래된 정보는 archive로 이동해.`
...
3. `.agent/ai-context/02-progress.md`
4. `.agent/ai-context/03-open-issues.md`
5. `.agent/ai-context/04-rules.md`
6. `.agent/ai-context/05-handoff.md`
7. `.agent/ai-context/logs/YYYY-MM-DD-session-log.md`

Archive:
- `.agent/ai-context/archive/YYYY-MM-DD/`

## 4) 자동 구성 절차 (AI 실행용)
1. `.agent/ai-context` 파일 목록을 읽고 Active/Archive를 분리한다.
...
`이 문서를 운영 기준으로 사용해 .agent/ai-context를 자동 재구성하고, 완료 후 변경 요약과 남은 리스크를 보고해.`
